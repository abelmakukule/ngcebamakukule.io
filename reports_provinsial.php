...
<html>
    <head>
        ...
        <title>Provisional Reports</title>
                            ...
                            <?php
                                ...
                                if($row7['role'] == "admin")
                                {
                                    ?>
                                        ...
                                        <a href="reports_national.php">PROVINCIAL REPORT</a><br />
                                    <?php
                                }
                            ?>
                        <?php
